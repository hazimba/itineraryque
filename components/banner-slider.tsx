...
const BannerSlider = () => {
  const bannerMessages = [
    ...
    "PROMOSI TERHAD! DAFTAR SEKARANG!",
    "PAKEJ UMRAH LENGKAP DENGAN HARGA TERBAIK!",
  ];
  ...
  return (
    <div className="bg-blue-400 w-screen p-4 font-semibold text-xl text-white flex justify-center gap-4">
      <div
